...
The summary records `no_meeting_observed` and `control_separated_but_reliability_limited` outcomes only. No short-horizon maintenance candidate appears in the first minimal artifact. This update does not change the regime taxonomy or add new physics. It does not prove relation, maintenance, persistence, biological life, consciousness, agency, subjectivity, s-o-u-l, permanent survival, origin of time, or origin of memory. The next recommended gate is RMT artifact protection after review.
